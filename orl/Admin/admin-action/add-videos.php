  ...
  <section class="height">
    <div class="add-admin-form">
      ...
      <form method="POST">
        ...
        <input class="in" type="text" name="videoid" placeholder="ID" /><br />
        <label>Video Name</label><br />
        <input type="text" name="videoname" placeholder="Video Name" class="in" /><br />
        <label>Active</label>
        <input type="radio" name="active" class="a" value="Yes" /><span>Yes</span>
        <input type="radio" name="active" class="a" value="No" /><span>No</span>
        <br />
...
if (isset($_POST['submit'])) {
  ...
  if ($res) {
    $_SESSION['add'] = "New Video Added Successfully.";
    header('location:http://localhost/ORL/admin/admin-videos.php');
  } else {
    $_SESSION['add'] = "Failed To Add New Video.";
    header('location:http://localhost/ORL/admin/admin-videos.php');
  }
}
